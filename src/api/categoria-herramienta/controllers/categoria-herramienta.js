...
module.exports = createCoreController('api::categoria-herramienta.categoria-herramienta', ({ strapi }) => ({
  async find(ctx) {
  ...
  async create(ctx) {
    ...
    const existe = await strapi.entityService.findMany('api::categoria-herramienta.categoria-herramienta', {
